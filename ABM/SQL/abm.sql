...
GO
    ...
    AS
    SELECT     TOP (100) PERCENT NProf, UPPER(LTRIM(Apellidoprof) + ',  ' + LTRIM(Nombreprof)) AS ApeYNom  FROM dbo.Profesores  order by UPPER(LTRIM(Apellidoprof) + ',  ' + LTRIM(Nombreprof))
