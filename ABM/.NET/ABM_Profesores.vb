...
Public Class ABM_Profesores
    ...
    'FROM         dbo.Profesores
    'where NProf<>68 and NProf<>74 and NProf<>2
    ...
    Sub buscar(ByVal condicion As String)
        ...
        If ds.Tables("Profesores").Rows.Count = 0 Then
    ...
    Sub CargarCamposProfesores()
        ...
        Else
            ...
            Dim ds As New DataSet
            da.Fill(ds, "Profesores")
            TextBox1.Text = ds.Tables("Profesores").Rows(0)("apellido")
            TextBox2.Text = ds.Tables("Profesores").Rows(0)("nombres")
            TextBox3.Text = ds.Tables("Profesores").Rows(0)("doc")

            TextBox4.Text = ds.Tables("Profesores").Rows(0)("Dirección")
            TextBox5.Text = ds.Tables("Profesores").Rows(0)("localidad")
            TextBox8.Text = ds.Tables("Profesores").Rows(0)("provincia")
            TextBox6.Text = ds.Tables("Profesores").Rows(0)("teléfonos")
            TextBox7.Text = ds.Tables("Profesores").Rows(0)("email")
            CheckBox1.Checked = IIf(ds.Tables("Profesores").Rows(0)("estado") = 0, False, True)


            TextBox12.Text = ds.Tables("Profesores").Rows(0)("comentarios")

            DateTimePicker1.Value = ds.Tables("Profesores").Rows(0)("fechanacimiento")
        End If
    End Sub
