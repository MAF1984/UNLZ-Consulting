...
Public Class Usuarios
    ...
    Sub buscar(ByVal condicion As String)
        ...
        da.Fill(ds, "tablaUsuarios")
        If ds.Tables("tablaUsuarios").Rows.Count = 0 Then
        ...
        Else
            ...
            DataGridView1.DataSource = ds.Tables("tablaUsuarios")
    ...
    Private Sub bAceptar_Click(sender As Object, e As EventArgs) Handles bAceptar.Click
        ...
        If SQL_Accion("update [UNLZConsultingABM].[dbo].[idm] set  Usuario='" & tUsuario.Text.Trim.ToUpper.Replace("'", "´") & "', Clave='" & tContraseña.Text.Trim.ToUpper.Replace("'", "´") & "', Nombre='" & tNombre.Text.Trim.ToUpper.Replace("'", "´") & "',Apellido='" & tApellido.Text.Trim.ToUpper.Replace("'", "´") & "', Email='" & tEmail.Text.Trim.ToUpper.Replace("'", "´") & "' where Id=" & Val(lLegajo.Text)) = True Then
    ...
    Private Sub bEliminar_Click(sender As Object, e As EventArgs) Handles bEliminar.Click
        ...
        If SQL_Accion("delete from [UNLZConsultingABM].[dbo].[Id]  where  Id=" & Val(lLegajo.Text)) = False Then
